...
public class ActionBarHelperBase extends ActionBarHelper {
    ...
    private View addActionItemCompatFromMenuItem(final MenuItem item) {
       ...
       View actionButton = null;
        
        if(item.getIcon() != null)
        {
	        
	        // Create the button
	        ImageButton imageButton = new ImageButton(mActivity, null,
        ...
        {
        	TextView tvButton = new TextView(mActivity, null,
	                itemId == android.R.id.home
                    ? R.attr.actionbarCompatItemHomeStyle
                    : R.attr.actionbarCompatTextItemStyle);
        	
        	tvButton.setLayoutParams(new ViewGroup.LayoutParams(
        			ViewGroup.LayoutParams.WRAP_CONTENT,
	                         ViewGroup.LayoutParams.FILL_PARENT));
        	tvButton.setText(item.getTitle().toString().toUpperCase());
        	tvButton.setContentDescription(item.getTitle());
	        ...
	        actionBar.addView(tvButton);
	        actionButton = tvButton;
